...
// Get all patients (minimal example)
router.get('/patients', async (req, res) => {
  try {
    const result = await pool.query('SELECT patient_id, first_name, last_name, dob, sex, phone, allergies FROM patients ORDER BY last_name, first_name');
